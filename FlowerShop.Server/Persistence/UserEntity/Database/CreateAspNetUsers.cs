    ...
    public class CreateAspNetUsers : Migration
    {
        public override void Up()
        {
            Create.Table("AspNetUsers")
                ...
                .WithColumn(nameof(Models.UserEntity.AspNetUsers.Name)).AsString().Nullable()
                .WithColumn(nameof(Models.UserEntity.AspNetUsers.Surname)).AsString().Nullable()
                .WithColumn(nameof(Models.UserEntity.AspNetUsers.TelephoneNumber)).AsString().Nullable()
                .WithColumn(nameof(Models.UserEntity.AspNetUsers.EmailAddress)).AsString().Nullable()
                .WithColumn(nameof(Models.UserEntity.AspNetUsers.Login)).AsString().Nullable()
